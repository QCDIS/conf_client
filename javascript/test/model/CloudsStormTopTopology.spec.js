...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CloudsStormTopTopology', function() {
      beforeEach(function() {
        instance = new Conf.CloudsStormTopTopology();
      });

      it('should create an instance of CloudsStormTopTopology', function() {
        // TODO: update the code to test CloudsStormTopTopology
        expect(instance).to.be.a(Conf.CloudsStormTopTopology);
      });
