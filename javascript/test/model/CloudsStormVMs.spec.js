...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CloudsStormVMs', function() {
      beforeEach(function() {
        instance = new Conf.CloudsStormVMs();
      });

      it('should create an instance of CloudsStormVMs', function() {
        // TODO: update the code to test CloudsStormVMs
        expect(instance).to.be.a(Conf.CloudsStormVMs);
      });
