...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NodeTemplateMap', function() {
      beforeEach(function() {
        instance = new Conf.NodeTemplateMap();
      });

      it('should create an instance of NodeTemplateMap', function() {
        // TODO: update the code to test NodeTemplateMap
        expect(instance).to.be.a(Conf.NodeTemplateMap);
      });
