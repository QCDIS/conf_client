...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VMMetaInfo', function() {
      beforeEach(function() {
        instance = new Conf.VMMetaInfo();
      });

      it('should create an instance of VMMetaInfo', function() {
        // TODO: update the code to test VMMetaInfo
        expect(instance).to.be.a(Conf.VMMetaInfo);
      });
