...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CredentialInfo', function() {
      beforeEach(function() {
        instance = new Conf.CredentialInfo();
      });

      it('should create an instance of CredentialInfo', function() {
        // TODO: update the code to test CredentialInfo
        expect(instance).to.be.a(Conf.CredentialInfo);
      });
