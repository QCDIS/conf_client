...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TopologyTemplate', function() {
      beforeEach(function() {
        instance = new Conf.TopologyTemplate();
      });

      it('should create an instance of TopologyTemplate', function() {
        // TODO: update the code to test TopologyTemplate
        expect(instance).to.be.a(Conf.TopologyTemplate);
      });
