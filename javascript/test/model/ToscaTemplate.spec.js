...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ToscaTemplate', function() {
      beforeEach(function() {
        instance = new Conf.ToscaTemplate();
      });

      it('should create an instance of ToscaTemplate', function() {
        // TODO: update the code to test ToscaTemplate
        expect(instance).to.be.a(Conf.ToscaTemplate);
      });
