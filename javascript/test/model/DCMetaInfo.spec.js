...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DCMetaInfo', function() {
      beforeEach(function() {
        instance = new Conf.DCMetaInfo();
      });

      it('should create an instance of DCMetaInfo', function() {
        // TODO: update the code to test DCMetaInfo
        expect(instance).to.be.a(Conf.DCMetaInfo);
      });
